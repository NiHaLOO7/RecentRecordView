...
const openAndCloseDropdown = (opr = 'close',compObj)=>{
...
function handleKeyDownOnInput(event,compObj) {
...
function handleKeyUpOnInput(event,compObj){
    if(compObj.comboboxObj.autocomplete){
        filterDropdownList(event,compObj);
    }
}

function handleDropdownOnInputClick(event,compObj){
...
function syncComboboxAttributes(compObj){
    const inputElement = compObj.template.querySelector('input.selection-input');
    if(!inputElement){
        return;
    }
...
function handleOptionClickAction(event,compObj){
...
function handleOptionHoverAction(event,compObj){
    const template = compObj.template;
...
function clearSelectionOnAutocomplete(compObj){
...
function handleSelectionRemovalAction(event,compObj){
    const template = compObj.template;
...
function evaluateExpression(value, condition) {
    return (new Function('value', '"use strict";return (' + condition + ')' )(value));
}

function compareArrayObject(array1, array2) {
...
export default {
    ...
    handleKeyUpOnInput,
    handleDropdownOnInputClick,
    syncComboboxAttributes,
    handleOptionClickAction,
    handleOptionHoverAction,
    clearSelectionOnAutocomplete,
    handleSelectionRemovalAction,
    evaluateExpression,
    compareArrayObject
}
// -------------------------------------------------
